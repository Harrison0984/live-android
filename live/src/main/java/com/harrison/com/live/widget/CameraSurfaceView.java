package com.harrison.com.live.widget;
...
import com.harrison.com.live.CameraHelper;
import com.harrison.com.live.CameraRecordRenderer;
import com.harrison.com.live.CommonHandlerListener;
                ...
                mBackgroundHandler.post(new Runnable() {
                    @Override public void run() {
                        CameraController.getInstance()
                                .setupCamera(surfaceTexture, width);
