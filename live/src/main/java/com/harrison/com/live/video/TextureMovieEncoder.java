...
public class TextureMovieEncoder implements Runnable {
    ...
    private MediaMuxerWrapper mRecorder;
    private MediaVideoEncoder mRecorderEncoder;
    ...
    public void frameAvailable(float[] texMatrix, long timestamp) {
        ...
        if (mRecorderEncoder != null)
            mRecorderEncoder.frameAvailableSoon(texMatrix);
    ...
    private void prepareEncoder(EGLContext sharedContext, int width, int height, int bitRate,
            File outputFile) {
        try {
            //mRecorder = new MediaMuxerWrapper(outputFile.toString());
            mRecorder = new RtmpMuxerWrapper();
            mRecorderEncoder = new MediaVideoEncoder(mRecorder, mMediaEncoderListener, width, height);
            new MediaAudioEncoder(mRecorder, mMediaEncoderListener);
            mRecorder.prepare();
        ...
        mInputWindowSurface = new WindowSurface(mEglCore, mRecorder.getInputSurface(), true);
        mInputWindowSurface.makeCurrent();
