package com.harrison.com.live.filter;
...
import com.harrison.com.live.R;
...
public class CameraFilter extends AbstractFilter implements IFilter {
    ...
    @Override public void onDraw(float[] mvpMatrix, FloatBuffer vertexBuffer, int firstVertex, int vertexCount, int coordsPerVertex, int vertexStride, float[] texMatrix,
